...
public class ImageManipulation {
    ...
    //  -nothing
    //Parameters:
    //  -i and j for forloop, int[] rgbprompts for user rgb values, 2d array
    //  -of color constructs of the image that the user inputs
    public static void applyFilter(int i, int j, int[] rgbPrompts, Color[][] pixels){
        Color originalColor = pixels[i][j];
                int red = originalColor.getRed();
                int green = originalColor.getGreen();
                int blue = originalColor.getBlue();
